...
pub static LANGUAGES: &[LanguageConfig] = &[
    LanguageConfig {
        name: "rust",
        extensions: &["rs"],
        language_fn: rust_lang,
        extractor: "rust",
    },
    LanguageConfig {
        name: "python",
        extensions: &["py"],
        language_fn: python_lang,
        extractor: "python",
    },
    LanguageConfig {
        name: "typescript",
    ...
    LanguageConfig {
        ...
        language_fn: cpp_lang,
        extractor: "cpp",
    },
    LanguageConfig {
        name: "java",
        extensions: &["java"],
        language_fn: java_lang,
        extractor: "java",
    },
    LanguageConfig {
        name: "csharp",
        extensions: &["cs"],
        language_fn: csharp_lang,
        extractor: "csharp",
    },
    LanguageConfig {
        name: "php",
        extensions: &["php", "phtml"],
        language_fn: php_lang,
        extractor: "php",
    },
];

pub const SUPPORTED_EXTENSIONS: &[&str] = &[
    "rs", "py", "ts", "tsx", "js", "jsx", "mjs", "cjs", "go", "c", "h", "cpp", "cc", "cxx", "hpp",
    "java", "cs", "php", "phtml", "rb", "sh", "bash", "kt", "kts", "html", "css", "md", "txt",
    "json", "toml", "yaml", "yml",
];
